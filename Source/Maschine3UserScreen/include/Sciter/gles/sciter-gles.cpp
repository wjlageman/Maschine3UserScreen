#include "sciter-gles.h"

#include "../sciter-x.h"

/*
 * Define GalogenGetProcAddress.
 */

#define GalogenGetProcAddress(name) SciterEGLGetProcAddress(name)
...
static void  GL_APIENTRY _impl_glBlendBarrier () {
  _glptr_glBlendBarrier = (PFN_glBlendBarrier)GalogenGetProcAddress("glBlendBarrier");
   _glptr_glBlendBarrier();
}
PFN_glBlendBarrier _glptr_glBlendBarrier = _impl_glBlendBarrier;
...
static void  GL_APIENTRY _impl_glPrimitiveBoundingBox (GLfloat minX, GLfloat minY, GLfloat minZ, GLfloat minW, GLfloat maxX, GLfloat maxY, GLfloat maxZ, GLfloat maxW) {
  _glptr_glPrimitiveBoundingBox = (PFN_glPrimitiveBoundingBox)GalogenGetProcAddress("glPrimitiveBoundingBox");
   _glptr_glPrimitiveBoundingBox(minX, minY, minZ, minW, maxX, maxY, maxZ, maxW);
}
PFN_glPrimitiveBoundingBox _glptr_glPrimitiveBoundingBox = _impl_glPrimitiveBoundingBox;
