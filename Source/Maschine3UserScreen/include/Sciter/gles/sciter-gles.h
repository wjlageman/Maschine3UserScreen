...
typedef void  (GL_APIENTRY *PFN_glBlendBarrier)();
extern PFN_glBlendBarrier _glptr_glBlendBarrier;
#define glBlendBarrier _glptr_glBlendBarrier
...
extern PFN_glPrimitiveBoundingBox _glptr_glPrimitiveBoundingBox;
#define glPrimitiveBoundingBox _glptr_glPrimitiveBoundingBox
