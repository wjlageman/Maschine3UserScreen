...
/**Sciter Window Proc.*/
 OBSOLETE LRESULT SCAPI SciterProc(HWINDOW hwnd, UINT msg, WPARAM wParam, LPARAM lParam);
 ...
 * \param[in] reserved1 \b LPVOID, not used, set to NULL
 * \param[in] reserved2 \b LPVOID, not used, set to NULL
 * \param[in] parent \b HWINDOW, optional parent window.
 *
 **/
 HWINDOW SCAPI  SciterCreateWindow( UINT creationFlags,
                                            LPRECT frame,
                                            LPVOID reserved1, /// set to NULL
